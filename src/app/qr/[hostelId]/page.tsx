  ...
  return (
    <>
      ...
      <div
        style={{
          minHeight: '100dvh',
          background: 'linear-gradient(160deg, #0F2744 0%, #0d2240 40%, #1a3a5c 100%)',
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
          justifyContent: 'center',
      ...
      >
        ...
        <div style={{ position: 'absolute', top: -80, right: -80, width: 280, height: 280, borderRadius: '50%', background: 'rgba(245,158,11,0.06)', pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', bottom: -60, left: -60, width: 200, height: 200, borderRadius: '50%', background: 'rgba(245,158,11,0.05)', pointerEvents: 'none' }} />
        ...
        >
          Powered by <strong style={{ color: 'rgba(255,255,255,0.5)' }}>HostelPay Hub</strong>
        </p>
      </div>
    </>
  )
